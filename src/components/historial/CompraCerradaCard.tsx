...
export function CompraCerradaCard({ compra, onAbrir }: CompraCerradaCardProps) {
  return (
    <button
      ...
      className="flex min-h-16 w-full items-center justify-between rounded-xl border border-border bg-bg-elevated px-4 py-3 text-left shadow-card transition-transform active:scale-[0.98]"
    >
